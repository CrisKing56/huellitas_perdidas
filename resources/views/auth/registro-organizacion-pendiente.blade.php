...
<div class="bg-gray-50 min-h-screen flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-2xl bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sm:p-10">
        <div class="text-center">
            <div class="mx-auto w-16 h-16 rounded-full bg-yellow-100 text-yellow-600 flex items-center justify-center mb-5">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-3">Solicitud en revisión</h1>
            ...
            <p class="text-gray-600 leading-relaxed">
                ...
                ya fue recibida y actualmente está siendo revisada por el administrador.
            </p>
            ...
            <div class="mt-6 rounded-2xl bg-yellow-50 border border-yellow-100 px-5 py-4 text-sm text-yellow-800 text-left">
                <p class="font-semibold mb-2">¿Qué sigue ahora?</p>
                <ol class="list-decimal list-inside space-y-1">
                    <li>El administrador revisará la información de tu solicitud.</li>
                    <li>Mientras siga en revisión, todavía no podrás acceder al panel.</li>
