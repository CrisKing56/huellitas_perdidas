        ...
        <div style="background:#ffffff; border-radius:20px; overflow:hidden; border:1px solid #f1f5f9; box-shadow:0 8px 24px rgba(15,23,42,0.06);">
            <div style="background:linear-gradient(135deg, #22c55e, #16a34a); padding:28px 32px;">
                ...
                <p style="margin:10px 0 0 0; color:#dcfce7; font-size:15px;">
                    Alguien está interesado en adoptar una de tus mascotas.
                </p>
            </div>
            ...
            <div style="padding:32px;">
                ...
                <p style="margin:0 0 18px 0; font-size:16px; color:#374151; line-height:1.7;">
                    <strong>{{ $solicitanteNombre }}</strong> envió una solicitud para adoptar a
                ...
                <div style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:16px; padding:20px; margin-bottom:24px;">
                    ...
                    <p style="margin:0 0 10px 0; font-size:15px; color:#166534;">
                        <strong>Estado actual:</strong> {{ str_replace('_', ' ', $publicacion->estado) }}
                    </p>

                    <p style="margin:0; font-size:15px; color:#166534; line-height:1.6;">
                        Revisa la solicitud dentro del sistema para aceptarla o rechazarla.
                    </p>
                </div>

                <div style="margin-bottom:24px;">
                    <a href="{{ $urlSolicitudes }}"
                       style="display:inline-block; background:#16a34a; color:#ffffff; text-decoration:none; font-weight:bold; padding:14px 22px; border-radius:12px;">
                        Ver solicitudes recibidas
                    </a>
                </div>

                <p style="margin:0 0 12px 0; font-size:15px; color:#4b5563; line-height:1.7;">
                    Los datos de contacto del solicitante se liberarán conforme al flujo del sistema y podrás gestionar la adopción con mayor control.
                </p>
