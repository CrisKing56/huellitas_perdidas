...
<head>
    ...
    <style>
        ...
        .badge-suspendida { background-color: #fee2e2; color: #991b1b; } 
        ...
        <tbody>
            @forelse($usuarios as $user)
                <tr>
                    ...
                    <td>{{ $user->correo }}</td>
                    <td>
                        <span class="badge {{ $user->rol === 'ADMIN' ? 'badge-admin' : 'badge-usuario' }}">
                            {{ $user->rol }}
                        </span>
                    </td>
                    <td>
                        <span class="badge {{ $user->estado === 'ACTIVA' ? 'badge-activa' : 'badge-suspendida' }}">
                            {{ $user->estado }}
                        </span>
                    </td>
