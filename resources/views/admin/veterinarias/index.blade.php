...
<div class="space-y-8">
    <div>
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Gestión de veterinarias</h1>
        <p class="text-gray-500 text-lg">Administra veterinarias activas y solicitudes pendientes.</p>
    </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-5 align-top">
                                    <div class="flex flex-col md:flex-row gap-2 justify-center">
                                        ...
                                        @if($vet->estado_revision !== 'RECHAZADA')
                                            <form action="{{ route('admin.veterinarias.rechazar', $vet->id_organizacion) }}" method="POST">
                                                @csrf
                                                <button type="submit"
