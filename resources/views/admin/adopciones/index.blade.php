            ...
            <div>
                ...
                <div class="flex flex-col gap-3">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <a href="{{ route('admin.adopciones.index') }}" class="w-full h-12 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold transition flex items-center justify-center">
                            Limpiar
                        </a>
                    </div>
                    
                    <a href="{{ route('reportes.adopciones.pdf', request()->query()) }}" 
