        ...
        <form action="{{ route('extravios.update', $publicacion->id_publicacion) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            @method('PUT') <div class="p-8 space-y-10">
                ...
                <div class="pt-6 border-t border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                             <label class="block text-sm font-medium text-gray-700 mb-1">¿Está vacunado?</label>
                             <select class="w-full border-gray-300 rounded-lg shadow-sm focus:border-orange-500 focus:ring-orange-500 py-2.5 px-3 bg-white">
